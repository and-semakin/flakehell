...
setup(
    ...
    python_requires='>=3.5',
    project_urls={"Documentation": "https://flakehell.readthedocs.io/", "homepage": "https://github.com/life4/flakehell"},
    ...
    entry_points={"console_scripts": ["flakehell = flakehell:entrypoint", "flake8helled = flakehell:flake8_entrypoint"], "flake8.extension": ["pylint = flakehell.plugins:PyLintChecker"], "flake8.report": ["baseline = flakehell.formatters:BaseLineFormatter", "colored = flakehell.formatters:ColoredFormatter", "gitlab = flakehell.formatters:GitlabFormatter", "grouped = flakehell.formatters:GroupedFormatter", "json = flakehell.formatters:JSONFormatter", "stat = flakehell.formatters:StatFormatter"]},
    packages=['flakehell', 'flakehell._logic', 'flakehell._patched', 'flakehell.commands', 'flakehell.formatters', 'flakehell.parsers', 'flakehell.plugins'],
    package_dir={"": "."},
    package_data={},
    install_requires=['entrypoints', 'flake8>=3.8.0', 'pygments', 'pylint', 'termcolor', 'toml', 'urllib3'],
    extras_require={"dev": ["dlint", "flake8-alfred", "flake8-annotations-complexity", "flake8-bandit", "flake8-broken-line", "flake8-bugbear", "flake8-builtins", "flake8-coding", "flake8-commas", "flake8-comprehensions", "flake8-debugger", "flake8-django", "flake8-docstrings", "flake8-eradicate", "flake8-executable", "flake8-future-import", "flake8-isort", "flake8-logging-format", "flake8-mock", "flake8-mutable", "flake8-pep3101", "flake8-pie", "flake8-print", "flake8-pytest", "flake8-quotes", "flake8-rst-docstrings", "flake8-scrapy", "flake8-strict", "flake8-string-format", "flake8-variables-names", "isort[pyproject]", "mccabe", "pep8-naming", "pytest", "typing-extensions", "wemake-python-styleguide"], "docs": ["alabaster", "pygments-github-lexers", "recommonmark", "sphinx"]},
)
